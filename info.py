...
CODE = (environ.get('CODE', 'https://telegra.ph/file/584cd1420a1aaacd92e22.jpg'))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002080592179') # support group id ( make sure bot is admin )
